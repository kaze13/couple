...
exports.config = {
  ...
  admin_user_email: process.env.ADMIN_USER_EMAIL || 'kaze13',//默认超级管理员的邮箱地址
  nodeMailer: {
    service: "Gmail",
...
exports.database = mongoskin.db(process.env.MONGOLAB_URI || "mongodb://localhost/nodetry");//数据库连接串
